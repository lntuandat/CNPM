...
namespace QLNS.NhanSu.ChildForm
{
    public partial class formDanhSachNhanVien : Form
    {
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                // Lọc chỉ hiển thị nếu MaNV khớp chính xác với giá trị tìm kiếm
                (dGVListNV.DataSource as System.Data.DataTable).DefaultView.RowFilter = string.Format("MaNV = '{0}'", searchValue);
            }
            else
            {
                // Xóa bộ lọc nếu không nhập giá trị
        ...
        private void btnXoaNV_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show($"Bạn có chắc chắn muốn xóa nhân viên có mã {maNV} không?",
                                                        "Xác nhận xóa",
            ...
            {
                MessageBox.Show("Xóa bị hủy.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
